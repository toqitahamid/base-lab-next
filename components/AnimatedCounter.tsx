    ...
    >
      <Card className="hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-white to-primary/5 border-0 hover:shadow-primary/20 overflow-hidden relative">
        ...
        <CardHeader className="pb-2 relative z-10">
          <motion.div className="text-5xl font-bold text-primary mb-2">
            {value.includes('+') ? (
              <span>
        ...
        <CardContent className="pt-0 relative z-10">
          <p className="text-muted-foreground font-medium group-hover:text-primary/80 transition-colors duration-300">
            {label}
          </p>
        </CardContent>
      </Card>
